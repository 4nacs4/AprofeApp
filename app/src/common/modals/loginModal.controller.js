...
(function(){
  ...
  /* @ngInject */
  function LoginModal($modalInstance, $http, $location, $timeout){
    var vm = this;
    vm.currentPage = 1;
    vm.itemsPerPage = 40;
    ...
    vm.user = {
          ...
          profileAvatar : '/images/avatars/noAvatar.png'
      };
    ...
    function setActiveState(nextState){
      ...
      vm.size = (nextState === 'forgotPassword' || nextState === 'forgotPasswordDone');
      if(nextState === 'forgotPassword'){
          $timeout(function(){vm.showForgotPasswordText = true;}, 400);
      }
      vm.user.username = '';
      vm.user.password = '';
      vm.user.email = '';
